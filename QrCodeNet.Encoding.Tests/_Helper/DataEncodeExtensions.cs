...
using QrCodeNet.Encoding.DataEncodation.InputRecognition;
using GMode = QrCodeNet.Encoding.DataEncodation.Mode;
using Mode = com.google.zxing.qrcode.decoder.Mode;
using QrCodeNet.Encoding.Common;


namespace QrCodeNet.Encoding.Tests._Helper
{
	internal static class DataEncodeExtensions
	{
		/// <summary>
        /// Combine QrCodeNet.Encoding input recognition method and version control method
        /// with legacy code. To create expected answer. 
        /// This is base on assume QrCodeNet.Encoding input recognition and version control sometime
